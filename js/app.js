...
module.config(function($routeProvider, $locationProvider){
    ...
    .when('/cottage', {
        controller: 'mainCtrl',
        templateUrl: 'pages/cottage.html'
    })
...
module.run(function ($rootScope, $location, $timeout) {
    ...
    // Listen for a route change success event
    $rootScope.$on("$routeChangeSuccess", function(event, currentRoute, previousRoute){
        // Scroll to the top of the page after route change success
        window.scrollTo(0, 0);
    });
...
module.controller('mainCtrl', function($scope, $location){
    ...
    /*
    $scope.img_locations = ["img/Web_01.jpg",
                            "img/Web_02.jpg",
                            "img/Web_03.jpg",
                            "img/Web_04.jpg",
                            "img/Web_05.jpg",
                            ...
                            "img/Web_17.jpg",
                            "img/Villa.jpg",
                            "img/Cormorant Beach_01.jpg",
                            "img/MerryBeach.jpg",
                            "img/MerryBeachKangaroos.jpg"];
    preloader.preloadImages($scope.img_locations);*/
});
